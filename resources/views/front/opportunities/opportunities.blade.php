    ...
    <!-- Alt Services Section -->
            ...
            <section id="services" class="services section">
                ...
                <div class="container section-title" data-aos="fade-up" style="padding-top: 20px">
                  ...
                  <br>
                  <a href="{{ route('scholarship') }} "><button type="button" class="btn btn-outline-success"><em>Get Started</em></button></a>
        ...
        <div class="container section-title" data-aos="fade-up">
            ...
            <br>
            <a href="{{ route('scholarship') }}"><button type="button" class="btn btn-outline-success"><em>Get Started</em></button></a><br><br>
          </div><!-- End Section Title -->
                </div>
