...
@section('title', 'FAQ: HCE')

@section('content')
<main class="main">

    <!-- Page Title -->
    <div class="page-title" data-aos="fade" style="background-image: url({{asset('main/assets/img/faq-bg.jpg')}});">
                        ...
                        <div class="accordion faq-accordian" id="faqAccordion">
                            ...
                            <div class="card border-0 wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                                ...
                                <div class="collapse" id="collapseFour" aria-labelledby="headingFour" data-parent="#faqAccordion">
                                    <div class="card-body">
                                        <p>Please visit the "Partners" page on our website to find contact information for each partner university.</p>
